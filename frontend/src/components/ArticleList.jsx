...
function ArticleList() {
  ...
  const [url, setUrl] = useState(`https://newsapi.org/v2/top-headlines?country=us&apiKey=aa267afd8cb14334b67cf2670eeab6a6&page=1`)
    ...
    function createTitleCards(){
      return(
        articleArr.map(article => {
          if((article.description && article.title !== "[Removed]") && (article.urlToImage)){
          return(
            <TitleCard 
        title={article.title}
